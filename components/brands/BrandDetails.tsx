...
// //                     hfghhfghfghfgh
// //                     <BankAccounts brandId={Number(brandId)} />
...
//     // Add this useEffect to fetch bank account data
//     useEffect(() => {
//         if (brand?.id) {
//             fetch(`${process.env.NEXT_PUBLIC_API_URL}/brand/${brand.id}/bank-account`, {
//                 headers: {
//                     Authorization: `Bearer ${token}`,
//                 },
//             })
...
//         if (!brand?.id || !bankAccount) return;

//         setSavingBankInfo(true);
//         try {
//             const method = bankAccount.id ? 'PUT' : 'POST';
//             const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/brand/${brand.id}/bank-account`, {
//                 method,
//                 headers: {
//                     'Authorization': `Bearer ${token}`,
//                     'Content-Type': 'application/json',
...
//                                             setIsTermsEdited(false);
//                                         }}
//                                         className="px-4 py-1 rounded-[32px] text-sm bg-gray-200 hover:bg-gray-300 text-black-700"
//                                     >
//                                         {(t('cancel_delete_brand'))}
//                                     </button>
//                                 )}
...
//                                     onClick={handleTermsUpdate}
//                                     disabled={!isTermsEdited || savingTerms}
//                                     className={`px-4 py-1 rounded-[32px] text-sm transition-colors ${isTermsEdited
//                                             ? 'bg-teal-500 text-white hover:bg-teal-600'
//                                             : 'bg-gray-200 text-black-500'
//                                         }`}
//                                 >
...
//                                 </div>
//                                 <div className="flex items-center justify-center gap-2 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-[32px] shadow-sm">
//       <div className="flex items-center space-x-2">
//         <ShoppingCart className="w-5 h-5 text-indigo-600" />
//         {/* <span className="text-sm font-medium text-gray-700">Total Purchases</span> */}
//       </div>
...
//                                 <button
//                                     onClick={handleSaveStatus}
//                                     className="px-6 py-2 bg-teal-500 text-white rounded-[32px] hover:bg-gray-600 transition-colors"
//                                 >
//                                     {t('saveChanges')}
//                                 </button>
//                             </div>
...
//                     <div className="bg-white rounded-2xl shadow-2xl p-4 md:p-7">
...
//                                 {/* Bank Account Form */}
//                                 <BankAccountForm brandId={brandId} />
