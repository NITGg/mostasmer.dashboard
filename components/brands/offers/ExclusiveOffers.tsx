...
//             toast.success(editingOffer ? t('brand_offerUpdateSuccess') : t('brand_offerAddSuccess'))
//             fetchExclusiveOffers()
//             handleCloseDialog()
//         } catch (error: any) {
//             console.error('Error details:', error)
...
//                     <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
//                         <div>
//                             <label className="block text-sm mb-1">{t('exclusive_offer_table_point_back')}</label>
//                             <input
//                                 type="number"
//                                 {...register('ratio', { required: 'Ratio is required' })}
//                                 className="w-full px-3 py-2 border rounded-lg"
...
//                                 className="px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-600"
//                             >
//                                 {loading ? t('brand_offerSaving') : editingOffer ? t('update') : t('add')}
//                             </button>
//                         </div>
//                     </form>
//                 </DialogContent>
