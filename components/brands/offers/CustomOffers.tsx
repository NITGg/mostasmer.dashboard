...
// import { useAppContext } from '@/context/appContext'
// // import { PencilSquareIcon, TrashIcon, PlusIcon } from '@heroicons/react/24/outline'
// import { TrashIconn, PencilSquareIcon,PluseCircelIcon, EditIcon } from '@/components/icons'
// import { Dialog, DialogContent } from '@/components/ui/dialog'
// import { useForm } from 'react-hook-form'
// import toast from 'react-hot-toast'
// import Table from '@/components/ui/Table'
...
//                 <Dialog open={!!deleteConfirmationId} onOpenChange={() => setDeleteConfirmationId(null)}>
//                     <DialogContent>
//                         <h2 className="text-lg font-semibold mb-4 text-center">{t('custom_offer_table_confirm_delete')}</h2>
//                         <p className="mb-4">{t('custom_offer_table_confirm_delete_message')}</p>
//                         <div className="flex justify-end space-x-3">
//                             <button
//                                 onClick={() => setDeleteConfirmationId(null)}
...
const CustomOffers = ({ brandId }: { brandId: string }) => {
    ...
    const [offerTypeInfo, setOfferTypeInfo] = useState<OfferTypeInfo | null>(null)
        ...
        <div className="mt-8">
            <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-2">
                    <h2 className="text-2xl font-bold">{offerTypeInfo?.name || t('loading')}</h2>
                    <button
            ...
            <Dialog open={showHelp} onOpenChange={setShowHelp}>
                <DialogContent>
                    <div className="p-4">
                        <h3 className="text-lg font-semibold mb-2">{offerTypeInfo?.name || t('loading')}</h3>
