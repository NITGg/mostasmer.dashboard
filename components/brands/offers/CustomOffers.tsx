...
const handlePageSizeChange = (newPageSize: number) => {
    ...
    const headers = [
        { name: 'custom_offer_table_id' },
        { name: 'custom_offer_table_title' },
        { name: 'custom_offer_table_point_back' },
        { name: 'custom_offer_table_valid_from' },
        { name: 'custom_offer_table_valid_to' },
        { name: 'custom_offer_table_actions' }
    ]
    ...
    const renderTableRows = () => (
        offers.map((offer) => (
            <tr key={offer.id} className="odd:bg-white even:bg-primary/5 border-b">
                ...
                <td className="px-6 py-4 font-medium">Custom offer</td>
