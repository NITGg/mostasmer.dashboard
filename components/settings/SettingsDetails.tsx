...
//     pointBackRatio: 0,
//     srRatio: 0,
//     loginAttemptDurationMinutes: 0,
//     loginAttempts: 0,
//     numberOfBrandsOnHomepage: 0,
//     numberOfCategoriesOnHomepage: 0,
//     numberOfSellingBrandsOnHomepage: 0,
//     numberOfLatestOffersOnHomepage: 0,
//     numberOfNewArrivalsOnHomepage: 0
//   });
...
//   useEffect(() => {
//     axios.get(`${process.env.NEXT_PUBLIC_BASE_URL}/api/app-settings`, {
//       headers: {
//         'Authorization': `Bearer ${token}`,
//         'Content-Type': 'application/json'
//       }
...
//         setSettingsFormData({
//           vat: settings.vat ?? 0,
//           pointBackRatio: settings.pointBackRatio ?? 0,
//           srRatio: settings.srRatio ?? 0,
//           loginAttemptDurationMinutes: settings.loginAttemptDurationMinutes ?? 0,
//           loginAttempts: settings.loginAttempts ?? 0,
//           numberOfBrandsOnHomepage: settings.numberOfBrandsOnHomepage ?? 0,
//           numberOfCategoriesOnHomepage: settings.numberOfCategoriesOnHomepage ?? 0,
//           numberOfSellingBrandsOnHomepage: settings.numberOfSellingBrandsOnHomepage ?? 1,
//           numberOfLatestOffersOnHomepage: settings.numberOfLatestOffersOnHomepage ?? 0,
//           numberOfNewArrivalsOnHomepage: settings.numberOfNewArrivalsOnHomepage ?? 0
//         });
//       })
//       .catch((error) => {
//         console.error('Error fetching settings:', error);
//         toast.error(t('error.failedToFetchSettings'));
//       });
//   }, [token]);

//   useEffect(() => {
//     console.log('Settings Form Data:', settingsFormData);
//   }, [settingsFormData]);
...
//           pointBackRatio: parseFloat(settingsFormData.pointBackRatio.toString()),
//           srRatio: parseFloat(settingsFormData.srRatio.toString()),
//           numberOfLatestOffersOnHomepage: parseInt(settingsFormData.numberOfLatestOffersOnHomepage.toString()),
//           numberOfSellingBrandsOnHomepage: parseInt(settingsFormData.numberOfSellingBrandsOnHomepage.toString()),
//           numberOfNewArrivalsOnHomepage: parseInt(settingsFormData.numberOfNewArrivalsOnHomepage.toString()),
//           loginAttemptDurationMinutes: parseInt(settingsFormData.loginAttemptDurationMinutes.toString()),
//           loginAttempts: parseInt(settingsFormData.loginAttempts.toString()),
//           numberOfBrandsOnHomepage: parseInt(settingsFormData.numberOfBrandsOnHomepage.toString()),
//           numberOfCategoriesOnHomepage: parseInt(settingsFormData.numberOfCategoriesOnHomepage.toString())
//         },
//         {
//           headers: {
//             'Authorization': `Bearer ${token}`,
...
//                     onChange={(e) => setSettingsFormData({ ...settingsFormData, vat: Number(e.target.value) })}
//                     className="px-3 py-2 border rounded-md w-48" />
//                 </div>
...
//                     type="number"
//                     value={settingsFormData.pointBackRatio}
//                     onChange={(e) => setSettingsFormData({ ...settingsFormData, pointBackRatio: Number(e.target.value) })}
//                     className="px-3 py-2 border rounded-md w-48" />
//                 </div>
...
//                     type="number"
//                     value={settingsFormData.srRatio}
//                     onChange={(e) => setSettingsFormData({ ...settingsFormData, srRatio: Number(e.target.value) })}
//                     className="px-3 py-2 border rounded-md w-48" />
//                 </div>
...
//                       ...prev, 
//                       numberOfLatestOffersOnHomepage: Number(e.target.value) 
//                     }))}
//                     className="px-3 py-2 border rounded-md w-48"
//                     min="0"
//                   />
...
//                   <input
//                     type="number"
//                     value={settingsFormData.numberOfSellingBrandsOnHomepage}
//                     onChange={(e) => setSettingsFormData({ ...settingsFormData, numberOfSellingBrandsOnHomepage: Number(e.target.value) })}
//                     className="px-3 py-2 border rounded-md w-48" />
//                 </div>
...
//                     onChange={(e) => setSettingsFormData(prev => ({ 
//                       ...prev, 
//                       numberOfNewArrivalsOnHomepage: Number(e.target.value) 
//                     }))}
//                     className="px-3 py-2 border rounded-md w-48"
//                     min="0"
//                   />
...
//                 />
//                 <InfoRow 
//                   label={t('numberOfBestSellingBrands')} 
//                   value={(settingsFormData.numberOfSellingBrandsOnHomepage ?? 0).toString()} 
//                 />
//                 <InfoRow 
...
//                   value={(settingsFormData.numberOfBrandsOnHomepage ?? 0).toString()} 
//                 />
//                 <InfoRow 
//                   label={t('numberOfCategoriesOnHomepage')} 
//                   value={(settingsFormData.numberOfCategoriesOnHomepage ?? 0).toString()} 
//                 />
//               </>
//             )}
//           </div>
