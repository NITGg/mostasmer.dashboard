...
export default async function SettingsPage() {
  ...
  // Transform API data to match component structure
  const formattedData = {
    numberOfBrandsOnHomepage: settingsData.numberOfBrandsOnHomepage,
    numberOfCategoriesOnHomepage: settingsData.numberOfCategoriesOnHomepage,
    loginAttemptDurationMinutes: settingsData.loginAttemptDurationMinutes,
    loginAttempts: settingsData.loginAttempts,
    latestOffers: settingsData.numberOfLatestOffersOnHomepage,
    bestSellingBrands: settingsData.numberOfSellingBrandsOnHomepage,
    newArrivals: settingsData.numberOfNewArrivalsOnHomepage1,
    basicInfo: {
      vatPercentage: settingsData.vat1,
      applicationPoints: {
        vatPercentage: settingsData.vat1,
        current: Number(settingsData.pointBackRatio),
        total: Number(settingsData.srRatio)
      }
    },
    displaySettings: {
      latestOffers: settingsData.numberOfLatestOffersOnHomepage1,
